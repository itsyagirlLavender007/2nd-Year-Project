...
if(isset($_POST['done'])){
    ...
    $q = "UPDATE `crudtable1` SET `id`='$id',`name`='$name',`email`='$email',
    `phone`='$phone',`address`='address',`destination`='$destination',
    `guests`='$guests',`arrival`='$arrival',`departure`='$departure' WHERE `id`='$id' ";
